...
files <- list.files(here(), pattern = "sci_attitude")
move_files(files, here("LTA_models"), overwrite = TRUE)
...
step3  <- mplusObject(
 ...
 processors = 10;",
  ...
  MODELCONSTRAINT = "  ! Compute joint and marginal probabilities:
        ...
        !tprob for GIRLS (note, I'm too lady to change tt11B to t11G
...
step3_fit <- mplusModeler(step3,
               dataout=here("cov_lta", "calc_tran.dat"), 
               modelout=here("cov_lta", "calc_tran.inp"), 
               check=TRUE, run = TRUE, hashfilename = FALSE)
```
...
lta_inv1 <- readModels(here("cov_lta","calc_tran.out" ), quiet = TRUE)
